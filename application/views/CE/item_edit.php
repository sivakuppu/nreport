...
<input id="item_id" type="text" name="item_id"  value=""  size="60" /> 
...
echo form_open('CE/item/update', $attributes);
?>
...
<p>
	...
	<?= form_textarea( array( 'name' => 'item_name', 'rows' => '5', 'cols' => '80', 'value' => $item_name) ) ?>
</p>
<p>
	...
	<?= form_textarea( array( 'name' => 'item_specification', 'rows' => '5', 'cols' => '80', 'value' => $item_specification) ) ?>
</p>
<p>
        <label for="manufacturer">Manufacturer</label>
        <?php echo form_error('manufacturer'); ?>
        <br /><input id="manufacturer" type="text" name="manufacturer" maxlength="255" value="<?php echo $manufacturer; ?>"  />
</p>
...
<p>
        ...
        <br /><input id="model" type="text" name="model" maxlength="255" value="<?php echo $model; ?>"  />
</p>

<p>
        <label for="capacity">Capacity</label>
        <?php echo form_error('capacity'); ?>
        <br /><input id="capacity" type="text" name="capacity" maxlength="255" value="<?php echo $capacity; ?>"  />
</p>
...
<p>
	...
	<?=form_textarea( array( 'name' => 'purpose', 'rows' => '5', 'cols' => '80', 'value' => $purpose)  )?>
</p>
<p>
        <label for="manufacturing_year">Manufacturing Year</label>
        <?php echo form_error('manufacturing_year'); ?>
        <br /><input id="manufacturing_year" type="text" name="manufacturing_year" maxlength="255" value="<?php echo $manufacturing_year; ?>"  />
</p>
</div>
<!--<p>
        <label for="cost_brand_new">Cost Brand New</label>
        <?php echo form_error('cost_brand_new'); ?>
        <br /><input id="cost_brand_new" type="text" name="cost_brand_new" maxlength="255" value="<?php echo $cost_brand_new; ?>"  />
</p>

<p>
        <label for="cost_reconditioned">Cost Reconditioned</label>
        <?php echo form_error('cost_reconditioned'); ?>
        <br /><input id="cost_reconditioned" type="text" name="cost_reconditioned" maxlength="255" value="<?php echo $cost_reconditioned; ?>"  />
</p>

<p>
        <label for="appraised_value">Appraised Value</label>
        <?php echo form_error('appraised_value'); ?>
        <br /><input id="appraised_value" type="text" name="appraised_value" maxlength="255" value="<?php echo $appraised_value; ?>"  />
</p>-->
