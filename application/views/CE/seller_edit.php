...
<input id="seller_search_text" type="text" name="seller_search_text"  value=""  size="60" />
<?php echo form_submit( 'submit', 'Get'); ?>
<?php echo form_close();?>        
</div>

<?php $attributes = array('class' => 'common-form', 'id' => 'seller-form'); echo form_open('CE/seller/update', $attributes); ?>
