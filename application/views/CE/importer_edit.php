...
<input id="importer_search_text" type="text" name="importer_search_text"  value=""  size="60" />
<?php echo form_submit( 'submit', 'Get'); ?>
<?php echo form_close();?>        
</div>

<?php $attributes = array('class' => 'common-form', 'id' => 'importer-form'); echo form_open('CE/importer/update', $attributes); ?>
