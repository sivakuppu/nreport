...
<?php echo form_open('CE/importer/get_search_data'); ?>
<input id="importer_search_text" type="text" name="importer_search_text"  value="<?php echo set_value('search_text'); ?>"  size="60" />
<?php echo form_submit( 'submit', 'Get'); ?>
<?php echo form_close()?>        
</div>

<?php $attributes = array('class' => 'common-form', 'id' => 'importer-form'); echo form_open('CE/importer', $attributes); ?>
...
<p>
        ...
        <br /><input id="code" type="text" name="code"  value="<?php echo set_value('code'); ?>"  />
</p>
