...
<input id="agent_search_text" type="text" name="agent_search_text"  value="<?php echo set_value('search_text'); ?>"  size="60" />
<?php echo form_submit( 'submit', 'Get'); ?>
<?php echo form_close()?>        
</div>

<?php $attributes = array('class' => 'common-form', 'id' => 'agent-form'); echo form_open('CE/agent', $attributes); ?>
